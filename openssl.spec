### RPM external openssl 0.9.8e__1.0.1e
...
Patch2: openssl-1.0.1e-disable-install_docs
Patch3: openssl-1.0.1e-initial-aarch64-bits
Patch4: openssl-1.0.1e-use-lib64-for-krb5
...
case "%{cmsplatf}" in
  osx*)
    ...
    ;;
  fc*)
    cfg_args="--with-krb5-flavor=MIT --with-krb5-dir=/usr enable-krb5"
    ;;
  *)
