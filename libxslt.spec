...
%build
./autogen.sh --prefix=%{i} --with-libxml-prefix=$LIBXML2_ROOT --with-libxml-include-prefix=$LIBXML2_ROOT/include  --with-libxml-libs-prefix=$LIBXML2_ROOT/lib --without-crypto
make
